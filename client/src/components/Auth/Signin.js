...
const input = ({
  ...
  <div className="signin__field">
    ...
    {!active &&
      touched &&
      (error && <span className="signin__error w3-red">{error}</span>)}
  </div>
);
